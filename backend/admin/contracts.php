    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
        <div class="overflow-x-auto">
            ...
            <?php if(empty($contracts)): ?>
                <div class="p-8 text-center text-slate-400">Nenhum contrato cadastrado.</div>
            <?php endif; ?>
        </div>
    </div>
            ...
            <div x-show="showModal" x-transition.scale class="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                ...
                <form method="POST" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Plano</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="monthly_price" x-model="form.monthly_price" required class="w-full px-3 py-2 border rounded dark:bg-slate-700 dark:border-slate-600 dark:text-white focus:border-brand-green outline-none font-bold text-green-600">
                        </div>
                    </div>
