      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 border-b ${scrolled ? theme.border : 'border-transparent'} ${theme.navBg}`}>
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#services" className="text-sm font-medium hover:text-[#2ECC40] transition-colors uppercase tracking-wider font-roboto">
              Especialidades
            </a>
            <a href="#projects" className="text-sm font-medium hover:text-[#2ECC40] transition-colors uppercase tracking-wider font-roboto">
              Portfólio
            </a>
            <button
              onClick={toggleTheme}
            ...
            <a
              href="#contact"
              className="bg-[#2ECC40] hover:bg-white hover:text-[#023047] text-[#023047] font-bold py-2.5 px-6 rounded shadow-[0_0_15px_rgba(46,204,64,0.4)] transition-all uppercase text-sm tracking-wide font-rajdhani"
            >
              Fale Conosco
            </a>
          </nav>
        ...
        {isMenuOpen && (
          <div className={`md:hidden absolute top-20 left-0 w-full ${theme.cardBg} border-b ${theme.border} p-6 shadow-2xl flex flex-col gap-4`}>
            <a href="#services" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-white/5">
              Especialidades
            </a>
            <a href="#projects" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-white/5">
              Portfólio
            </a>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className={`p-8 rounded-2xl border ${theme.border} ${theme.cardBg} hover:border-[#2ECC40] transition-all hover:-translate-y-2 group`}>
              ...
              <p className={`text-sm ${theme.textMuted} leading-relaxed`}>
                Criação de sites profissionais com <strong>WordPress</strong>. Entrega rápida e layouts modernos.
              </p>
            </div>
            ...
            <div className={`p-8 rounded-2xl border ${theme.border} ${theme.cardBg} hover:border-[#5D3FD3] transition-all hover:-translate-y-2 group`}>
              ...
              <p className={`text-sm ${theme.textMuted} leading-relaxed`}>
                Implementação completa de <strong>WooCommerce</strong> com integração de pagamentos e correios.
              </p>
            </div>
            ...
            <div className={`p-8 rounded-2xl border ${theme.border} ${theme.cardBg} hover:border-[#FF8D37] transition-all hover:-translate-y-2 group`}>
              ...
              <p className={`text-sm ${theme.textMuted} leading-relaxed`}>
                Domínio total dos principais construtores visuais do mercado.
              </p>
            </div>
          </div>
        </div>
